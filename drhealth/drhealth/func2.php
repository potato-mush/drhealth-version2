...
if (isset($_POST['patsub1'])) {
  ...
  // Prepend +63 to the contact number
  if (substr($contact, 0, 3) !== '+639') {
    $contact = '+639' . $contact;
  }

  // Combine City, city, and Barangay into one address
  ...
  $stmt->bind_param("ssssssss", $fname, $lname, $age, $gender, $email, $contact, $address, $hashedPassword); // Use the hashed password
